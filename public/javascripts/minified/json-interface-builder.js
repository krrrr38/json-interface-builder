...
(function(window, document, undefined) {
    ...
    function minErr(module, ErrorConstructor) {
        ...
        return function() {
            ...
            message = message + "\nhttp://errors.angularjs.org/1.3.2/" + (module ? module + "/" : "") + code;
...
!function(a, b) {
    "use strict";
    b.module("ngClipboard", []).provider("ngClip", function() {
        var a = this;
        ...
        ZeroClipboard.config(b.extend(c, a.config || {}));
        ...
        return {
            ...
            restrict: "A",
            link: function(a, c, d) {
                if (ZeroClipboard.isFlashUnusable()) return void c.bind("click", function(b) {
                    a.$apply(a.clipClickFallback({
                        $event: b,
                        copy: a.$eval(a.clipCopy)
                    }));
                });
                var e = new ZeroClipboard(c);
                "" === d.clipCopy && (a.clipCopy = function() {
                    return c[0].previousElementSibling.innerText;
                }), e.on("ready", function() {
                    e.on("copy", function(b) {
                        var c = b.clipboardData;
                        c.setData("text/plain", a.$eval(a.clipCopy));
                    }), e.on("aftercopy", function() {
                        b.isDefined(d.clipClick) && a.$apply(a.clipClick);
...
angular.module("jibApp", []).controller("TopCtrl", [ "$scope", TopCtrl ]).directive("componentBuilder", function() {
